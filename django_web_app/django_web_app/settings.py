...
# Allow configuring allowed hosts from environment (comma-separated). Example:
...
# Use WhiteNoise static file storage when not in DEBUG to serve compressed files
if not DEBUG:
